...
!(function (t, e) {
   ...
   function za(t, e) {
      var r;
      if (
         ((e._time || (e._initted && !e._dur)) && ((r = wa(t.rawTime(), e)), (!e._dur || yt(0, e.totalDuration(), r) - e._tTime > U) && e.render(r, !0)),
   ...
   function Va(t, e, r, i) {
      return Ja(tt(t) ? !e : !0 === r ? !!(r = 0) : !i, function () {
         return tt(t)
            ...
            : (r = r || 1e-5) && (i = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && Math.floor(Math.round((t + Math.random() * (e - t)) / r) * r * i) / i;
      });
   }
   ...
   function lb(t, e, r) {
      ...
      if (!_) {
         if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Ot[t])) _ = Ot[t];
            ...
            4 === t.length && (t = "#" + (i = t.charAt(1)) + i + (n = t.charAt(2)) + n + (a = t.charAt(3)) + a), (_ = [(t = parseInt(t.substr(1), 16)) >> 16, (t >> 8) & kt, t & kt]);
   ...
   function Bb(t, e) {
      for (var r, i = t._first; i; )
         i instanceof Bt
            ? Bb(i, e)
            : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === e || (i.timeline ? Bb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
            (i = i._next);
   }
   ...
   function qk(t) {
      ...
      if (
         (k < a && (A += a - C),
         (0 < (e = (i = (P += a) - A) - S) || s) && ((n = ++T.frame), (b = i - 1e3 * T.time), (T.time = i /= 1e3), (S += e + (D <= e ? 4 : D - e)), (r = 1)),
         s || (g = v(qk)),
         r)
      )
            ...
            if (v !== this._tTime || r || y) {
               if (
                  ...
                  if (
                     ((g = this._dur),
                     (m = this._tDur),
                     b && ((this._lock = 2), (c = T ? g + 1e-4 : -1e-4), this.render(c, !0), this.vars.repeatRefresh && !_ && this.invalidate()),
                     (this._lock = 0),
                     !this._ts && !u)
                  )
                     return this;
   ...
   var qt,
      ...
      Xt = (function (S) {
         function Tween(t, e, i, n) {
            ...
            if (
               ((a._targets = D.length ? Y(D) : M("GSAP target " + t + " not found. https://greensock.com", !j.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = w), x || b || u(v) || u(y))
            ) {
               if (
                  ((e = a.vars),
                  (o = a.timeline =
               ...
               if (_) {
                  ...
                  !(function _renderZeroDurationTween(t, e, r, i) {
                     var n,
                        ...
                        h = 0;
                     if (
                        (u && t._repeat && ((h = yt(0, t._tDur, e)), gt(h, u) !== (a = gt(t._tTime, u)) && ((s = 1 - o), t.vars.repeatRefresh && t._initted && t.invalidate())),
               ...
               if ("autoRound" !== f && ((s = e[f]), !ft[f] || !Nb(f, e, r, i, t, n)))
                  if (((h = typeof s), (l = Ge[f]), "function" === h && (h = typeof (s = s.call(r, i, t, n))), "string" === h && ~s.indexOf("random(") && (s = ab(s)), l))
                     ...
                     if (
                        ...
                        if (
                           (m ||
                              ((g = t._gsap).renderTransform || Qe(t), (v = !1 !== e.smoothOrigin && g.smooth), ((m = this._pt = new ie(this._pt, b, Ye, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                           "scale" === f)
                        )
...
export function registerPlugin(splittext, scrolltrigger) {
