                  ...
                  <div class="blog-details__meta">
                     <div class="blog-details__tags">
                        ...
                        <div class="sidebar__tags">
                           <NuxtLink v-for="tag in blogDetails.tags" :key="tag" to="/blog-list-right">{{ tag }}</NuxtLink>
                        </div>
                     </div>

                     <div class="blog-details__social">
                        <NuxtLink v-for="link in blogDetails.socialLinks" :key="link.name" :to="link.url" :style="{ '--accent-color': link.color }">
