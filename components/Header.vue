          ...
          <nav class="main-header__nav main-menu">
            <ul class="main-menu__list">
              <li class="megamenu megamenu-clickable megamenu-clickable--toggler" :class="{ current: route.path.startsWith('/') }">
                ...
                <ul :class="{ 'megamenu-clickable--active': ismegamenu }">
                  <li>
                    <div class="megamenu-popup">
                      <a href="#" class="megamenu-clickable--close">
                        <span class="icon-close" @click.prevent="ismegamenu = false"></span>
                      </a>
                                ...
                                <div class="demo-one__card">
                                  <div class="demo-one__image">
                                    ...
                                    <div class="demo-one__btns">
                                      <NuxtLink v-if="page.multiPageLink" :to="page.multiPageLink" class="careox-btn demo-one__btn">
                                        <span>Multi Page</span>
                                      </NuxtLink>
                                      <NuxtLink v-if="page.onePageLink" :to="page.onePageLink" class="careox-btn demo-one__btn">
                                        <span>One Page</span>
                                      </NuxtLink>
                                      <NuxtLink v-if="page.darkPageLink" :to="page.darkPageLink" class="careox-btn demo-one__btn">
                                        <span>Dark Page</span>
                                      </NuxtLink>
                                      <NuxtLink v-if="page.viewPageLink" :to="page.viewPageLink" class="careox-btn demo-one__btn">
                                        <span>View Page</span>
                                      </NuxtLink>
                                    </div>
                                  </div>
                                  <div class="demo-one__content">
                                    <h3 class="demo-one__title">
                                      <NuxtLink :to="page.multiPageLink || page.viewPageLink">
                                        {{ page.title }}
                                      </NuxtLink>
                                    </h3>
                                  </div>
...
const handleScroll = () => {
  ...
  if (scrollPosition > 70) {
    nav.classList.add("sticky-header--cloned", "sticky-fixed", "active");
    nav.classList.remove("sticky-header--normal");
  } else {
    nav.classList.remove("sticky-header--cloned", "sticky-fixed", "active");
    nav.classList.add("sticky-header--normal");
  }
};
...
<style scoped>
.current > a {
  /* Add your styles for active links here */
  color: var(--primary-color);
  font-weight: 600;
}

.dropdown.current > a::after {
  /* Style for dropdown arrows when active */
  color: var(--primary-color);
}
</style>
