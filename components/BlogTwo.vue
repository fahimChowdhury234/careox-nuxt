   ...
   <section class="blog-two" id="blog">
      <div class="container">
         <div class="sec-title text-center">
            <h6 class="sec-title__tagline bw-split-in-right"><span class="sec-title__tagline__border"></span>{{ blogData.sectionTitle.tagline }}</h6>
            <h3 class="sec-title__title bw-split-in-left" v-html="blogData.sectionTitle.title"></h3>
         </div>
         <div class="blog-one__carousel">
            <client-only>
               <div ref="slider" class="my-slider">
                  <div class="slide" v-for="(blog, index) in blogData.blogs" :key="blog.id">
...
<script setup>
import { blogData } from "@/data/BlogTwo";
