...
export default defineNuxtConfig({
   ...
   css: [
      ...
      "@/assets/vendors/icofont/icofont.min.css",
      "@/assets/vendors/careox-icons/style.css",
      "@/assets/css/custom.css",
   ],
   plugins: [
      "~/plugins/jarallax.client.ts",
      "~/plugins/tiny-slider.client.ts",
      "~/plugins/vue-observe-visibility.ts",
      "~/plugins/vue-select.client.ts",
      "~/plugins/loadStyles.client.ts",
      "~/plugins/auto-animate.client.ts",
   ],
   modules: ["@pinia/nuxt", "nuxt-swiper", "nuxt-splide"],
