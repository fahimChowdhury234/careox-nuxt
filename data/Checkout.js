...
const checkoutData = {
   ...
   billingDetails: {
      ...
      formFields: [
         { type: "select", name: "country", options: ["Canada", "England", "Australia"], placeholder: "Select a country" },
   ...
   orderSummary: {
      title: "Your order",
      items: [{ name: "Product Name", price: "$10.99 USD" }],
      summary: [
   ...
   paymentOptions: [
      {
         ...
         content: "Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won't be shipped until the funds have cleared.",
      },
      {
         id: "paypal",
