import image from "@/assets/images/products/product-details-1.png";
...
export const productsDetails = {
   ...
   description: {
      ...
      list: ["Nam at elit nec neque suscipit gravida.", "Aenean egestas orci eu maximus tincidunt.", "Curabitur vel turpis id tellus cursus laoreet."],
   },
   comments: [
      {
         id: 1,
